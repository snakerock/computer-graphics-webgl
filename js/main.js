...
function start() {
    ...
    scene.objects.push(new Object3D(gl, "terrain.json", lambertShader, depthMapshader, [0.0, -10.0, 0.0], 10));
    scene.objects.push(new Object3D(gl, "ozzy.json", lambertShader, depthMapshader, [0.0, -150.0, -50.0], 0.5));
